"""End-to-end: a matrix goes in, figures and tables come out, checks pass on the way."""
...
def test_analysis_refuses_to_proceed_when_a_check_fails(tmp_path):
    """A corrupted matrix must stop the pipeline rather than produce plausible figures."""
...
def test_matrix_stores_enough_to_reproduce_itself(tmp_path):
    """Published matrices must carry their seeds and splits, not just the bits."""
